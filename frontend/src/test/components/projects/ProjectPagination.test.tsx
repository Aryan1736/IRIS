...
describe("ProjectPagination", () => {
  it("renders correctly with given props and custom entity name", () => {
    render(
      <ProjectPagination
        page={2}
        pageSize={25}
  ...
  it("renders correctly with default entity name", () => {
    render(
      <ProjectPagination
        page={1}
        pageSize={25}
    ...
    expect(screen.getByText("SHOWING 1–25 OF 64,608 OBSERVATIONS")).toBeInTheDocument();
  });
